...
void set_initail_conditions()
{
	...
	CompressionStrength[0][1] = 100.0;
	TensionStrength[0][1] = 50.0;
	NaturalLength[0][1] = 2.0;
	
	CompressionStrength[0][2] = 100.0;
	TensionStrength[0][2] = 50.0;
	NaturalLength[0][2] = 2.0;
	
	CompressionStrength[0][3] = 100.0;
	TensionStrength[0][3] = 50.0;
	NaturalLength[0][3] = 2.0;
	
	CompressionStrength[1][2] = 100.0;
	TensionStrength[1][2] = 50.0;
	NaturalLength[1][2] = 2.0;
	
	CompressionStrength[1][3] = 100.0;
	TensionStrength[1][3] = 50.0;
	NaturalLength[1][3] = 2.0;
	
	CompressionStrength[2][3] = 100.0;
	TensionStrength[2][3] = 50.0;
	NaturalLength[2][3] = 2.0;

	CompressionStrength[0][4] = 100.0;
	TensionStrength[0][4] = 50.0;
	NaturalLength[0][4] = 2.0;

	CompressionStrength[1][4] = 100.0;
	TensionStrength[1][4] = 50.0;
	NaturalLength[1][4] = 2.0;

	CompressionStrength[2][4] = 100.0;
	TensionStrength[2][4] = 50.0;
